        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LimitAccess = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Locale = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Seo = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttributeGroupDescriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AttributeGroupDescriptions_AttributeGroups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "AttributeGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerGroupDescriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerGroupDescriptions_CustomerGroups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "CustomerGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerGroupDescriptions_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttributeDescriptions", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetaTagDescription = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    MetaTagKeywords = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    ...
                    Seo = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductDescriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductDescriptions_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetaTitle = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    MetaDescription = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    MetaKeyword = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryDescriptions_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagDescriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TagDescriptions_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TagDescriptions_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttributeGroupDescriptions_GroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryDescriptions_LanguageId",
                table: "CategoryDescriptions",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerGroupDescriptions_GroupId",
                table: "CustomerGroupDescriptions",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerGroupDescriptions_LanguageId",
                table: "CustomerGroupDescriptions",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductDescriptions_LanguageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagDescriptions_LanguageId",
                table: "TagDescriptions",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_TagDescriptions_TagId",
                table: "TagDescriptions",
                column: "TagId");
